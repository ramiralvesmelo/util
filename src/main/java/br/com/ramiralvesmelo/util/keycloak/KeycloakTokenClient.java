...
public class KeycloakTokenClient {
    ...
    /** URL base da API que será consumida (ex.: http://localhost:8080/api). */
    @NonNull
    private final String apiBaseUrl;

    /** URL base do Keycloak (ex.: http://localhost:8081). */
    @NonNull
    private final String keycloakBaseUrl;

    /** Realm alvo. Ex.: app-api-realm */
    @NonNull
    private final String realm;

    /** Client ID do Keycloak. */
    @NonNull
    ...
    public String getTokenUrl() {
        return ensureNoTrailingSlash(keycloakBaseUrl) +
