...
class AuditLogEventTest {
    ...
    void shouldBuildWithFields() {
        ...
        assertThat(event.getPayload()).containsEntry("user", "alice")
    ...
    void jacksonSerializationRoundTrip() throws Exception {
        ...
        AuditLogEvent original = AuditLogEvent.builder()
                .id("J-1")
                .payload(Map.of("a", 10, "b", "str"))
                .build();
        ...
        assertThat(restored.getPayload()).containsEntry("a", 10)
                                         .containsEntry("b", "str");
    }
